...
const I18N = {
  ...
  translations: {
    en: {
      ...
      'settings.version': 'XPGains v0.4 - Train your skills!',
    ...
    de: {
      ...
      'settings.about': 'Über',
      'settings.version': 'XPGains v0.4 - Trainiere deine Skills!',
    ...
    ru: {
      ...
      'challenges.start': 'Начать испытание',
      ...
      'settings.version': 'XPGains v0.4 - Тренируй свои навыки!',
